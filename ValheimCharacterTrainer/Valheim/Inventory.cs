...
namespace Valheim
{
    public class Inventory
    {
        ...
        //private bool AddItem(ItemData item, int amount, int x, int y)
        //{
        //    amount = Mathf.Min(amount, item.m_stack);
        //    if (x < 0 || y < 0 || (x >= this.m_width || y >= this.m_height))
        //        return false;
        //    ItemData itemAt = this.GetItemAt(x, y);
        //    bool flag;
        //    if (itemAt != null)
        //    {
        ...
        //public bool CanAddItem(ItemData item, int stack = -1)
        //{
        ...
        //        {
        //            ItemData freeStackItem = this.FindFreeStackItem(item.m_shared.m_name, item.m_quality);
        ...
        //private bool TopFirst(ItemData item)
        //{
        //    return item.IsWeapon() || item.m_shared.m_itemType == ItemData.ItemType.Tool || (item.m_shared.m_itemType == ItemData.ItemType.Shield || item.m_shared.m_itemType == ItemData.ItemType.Utility);
        //}

        //public void MoveAll(Inventory fromInventory)
        //{
        //    List<ItemData> itemDataList1 = new List<ItemData>((IEnumerable<ItemData>)fromInventory.GetAllItems());
        ...
        //    }
        //    foreach (ItemData itemData in itemDataList2)
        //    {
        ...
        //public void MoveItemToThis(Inventory fromInventory, ItemData item)
        //{
        ...
        //        }
        //    }
        //    this.m_inventory.RemoveAll((Predicate<ItemData>)(x => x.m_stack <= 0));
        //    this.Changed();
        //}
        ...
        //public ItemData GetAmmoItem(string ammoName)
        //{
        //    int num1 = 0;
        //    ItemData itemData1 = (ItemData)null;
        //    foreach (ItemData itemData2 in this.m_inventory)
        //    {
        //        if ((itemData2.m_shared.m_itemType == ItemData.ItemType.Ammo || itemData2.m_shared.m_itemType == ItemData.ItemType.Consumable) && itemData2.m_shared.m_ammoType == ammoName)
        //        {
        ...
        //private ItemData FindFreeStackItem(string name, int quality)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        ...
        //    {
        //        ItemData itemData = this.m_inventory[index];
        ...
        //public ItemData GetOtherItemAt(int x, int y, ItemData oldItem)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        ...
        //public List<ItemData> GetEquipedtems()
        //{
        ...
        //public void GetWornItems(List<ItemData> worn)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        ...
        //public void GetValuableItems(List<ItemData> items)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        ...
        //public void GetAllItems(string name, List<ItemData> items)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        //        if (itemData.m_shared.m_name == name)
        ...
        //public void GetAllItems(ItemData.ItemType type, List<ItemData> items)
        //{
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
        ...
        //    foreach (ItemData itemData in original.m_inventory)
        //    {
        //        if (!itemData.m_shared.m_questItem && !itemData.m_equiped)
        //            this.m_inventory.Add(itemData);
        //    }
        //    original.m_inventory.RemoveAll((Predicate<ItemData>)(x => !x.m_shared.m_questItem && !x.m_equiped));
        //    original.Changed();
        //    this.Changed();
        //}
        ...
        //public void GetBoundItems(List<ItemData> bound)
        //{
        //    bound.Clear();
        //    foreach (ItemData itemData in this.m_inventory)
        //    {
